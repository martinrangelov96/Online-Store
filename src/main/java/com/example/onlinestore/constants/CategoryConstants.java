...
public final class CategoryConstants {
    ...
    public final static String EDIT_CATEGORY_BY_ID_GET = "/edit-category/{id}";
    public final static String EDIT_CATEGORY_BY_ID_PATCH = "/edit-category/{id}";
    public final static String DELETE_CATEGORY_BY_ID_GET = "/delete-category/{id}";
    public final static String DELETE_CATEGORY_BY_ID_DELETE = "/delete-category/{id}";

    public final static String ADD_CATEGORY_VIEW_NAME = "/categories/add-category";
    public final static String ALL_CATEGORIES_URL = "/categories/all-categories";
